class emailVerificationEmail {
    ...
    get text() {         
        ...
        An account with this email was created at www.neverforgetit.net. If you want to verify the email click the link: ${this.emailVerificationLink}.
    ...
    get html() { 
        ...
        <p>An account with this email was created at www.neverforgetit.net. If you want to verify the email click the link: <a href="${this.emailVerificationLink}">Verify email</a></p>
...
module.exports = emailConfirmationEMail